...
Storefront is an online store API that manages authentications for users and allow them to view a list of available products to purchase, add them to a shopping cart and ultimately complete the ordering process.
